...
- [llm | Rust](https://github.com/rustformers/llm)
- [candle | Rust](https://github.com/huggingface/candle)
- [OpenLLM | Python](https://github.com/bentoml/OpenLLM)
- [minGPT | Python](https://github.com/karpathy/minGPT)
- [langchain | Python](https://github.com/langchain-ai/langchain)
- [LLMZoo | Python](https://github.com/FreedomIntelligence/LLMZoo)
- [llm-colosseum | Python](https://github.com/OpenGenerativeAI/llm-colosseum)
- [Time-LLM | Python](https://github.com/KimMeen/Time-LLM)
- [SWE-agent | Python](https://github.com/princeton-nlp/SWE-agent)
- [gemma | Python](https://github.com/google-deepmind/gemma)
